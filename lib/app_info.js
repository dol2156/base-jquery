window.addEventListener('DOMContentLoaded', (event) => {
  const html = `
  <div id="AppInfo" class="hidden rounded-[4px] [[data-env='dev'][data-scroll-top='0']_&]:flex z-[9999] fixed top-[0] left-1/2 -translate-x-1/2 bg-[rgba(0,0,0,.7)] p-[5px_10px] text-[yellow] text-[12px] font-[400] whitespace-nowrap flex-row items-center justify-center gap-[10px]">
    <div>
